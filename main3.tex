...
\subsection{Russian}
\textcyrillic{Привет мир! Это тест кириллицы: а, б, в, г, д, е, ё, ж, з, и, й, к.}

\subsection{Greek}
\textgreek{Γεια σου κόσμε! Ελληνικά γράμματα: α, β, γ, δ, ε, ζ, η, θ, λ, μ, π, σ, ω.}
...
Greek letters in math mode: \textgreek{α, β, γ, δ, ε, ζ, η, θ, λ, μ, π, σ, τ, φ, χ, ψ, ω}
...
Latin with Greek: The symbol \textgreek{π} (pi) represents 3.14159...

Numbers in different scripts: 123 (Western), \textcjk{一二三} (Chinese), \textarabic{١٢٣} (Arabic)
